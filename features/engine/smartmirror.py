...
weather_api_token = '41b8b4a6bd9a2eab10bee47b49dc70fd' # create account at https://darksky.net/dev/
...
class Clock(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.time1 = ''
        self.timeLbl = Label(self, font=('Gothic', large_text_size), fg="white", bg="black")
        self.timeLbl.pack(side=TOP, anchor=E)
        # initialize day of week
        self.day_of_week1 = ''
        self.dayOWLbl = Label(self, text=self.day_of_week1, font=('Gothic', small_text_size), fg="white", bg="black")
        self.dayOWLbl.pack(side=TOP, anchor=E)
        # initialize date label
        self.date1 = ''
        self.dateLbl = Label(self, text=self.date1, font=('Gothic', small_text_size), fg="white", bg="black")
